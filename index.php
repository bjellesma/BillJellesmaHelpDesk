        ...
        <div class="col-md-6">
          <section id="wj_recent_work">
            ...
            <div class="wj_recent_work_item">
              <a href="https://github.com/bjellesma/BillJellesmaHelpDesk"><img src="images/PyChat-1.PNG">
              PyChat</a>
              <p>A chat program written in Python</p>
            </div>
            <div class="wj_recent_work_item">
              <a href="https://github.com/bjellesma/Java-Chat-and-Bot"><img src="images/Java-Chat-1.PNG">
              Java Chat and Bot</a>
            ...
            <div class="wj_recent_work_item">
              <a href="https://github.com/bjellesma/Udacity-FSND-Movie-Trailer-Website"><img src="images/Movie-Trailer-Website-1.PNG">
              Movie Trailer Website</a>
              <p>A mini python web server used to build a database of your favorite movie. Also makes use of IMDB's API to grab metadata. Clicking on the items will bring up a youtube trailer.</p>
            </div>
            <div class="wj_recent_work_item">
              <a href="https://github.com/bjellesma/PhpPalette"><img src="images/PhpPalette-1.PNG">
              PhpPalette</a>
